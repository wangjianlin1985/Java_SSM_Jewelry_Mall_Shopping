...
<body>
	<div id="contleft">
		<ul class="menu">
			...
			<li class="level1">
			<a href="javascript:void(0)">珠宝类型管理</a>
				<ul class="level2">
	                <li><a href="<%=basePath%>back/addgoodstypev">添加珠宝种类</a></li>
	                <li><a href="<%=basePath%>back/rolegoodstypelist?currentPage=1">珠宝种类列表</a></li>
                </ul>
			</li>
			<li class="level1">
			<a href="javascript:void(0)">珠宝管理</a>
				<ul class="level2">
					<li><a href="<%=basePath%>back/rolegoodslist?currentPage=1">珠宝列表</a></li>
		   			<li><a href="<%=basePath%>back/goodstypelist">珠宝添加</a></li>
                </ul>
			</li>
			<li class="level1">
