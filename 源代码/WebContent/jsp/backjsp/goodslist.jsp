...
<body>
		<div class="goodlist">
			...
			<c:if test="${empty goodslist.list}">
				<h3 style="margin-top:30px;">还未有珠宝信息</h3>
			</c:if>
			</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">修改珠宝信息</h4>
            </div>
            ...
            <form action="savegoods" method="post" id="savegoods" enctype="multipart/form-data">
        		<div class="col-sm-12">
        			<div class="form-group col-sm-6">
		                ...
		                <label class="col-sm-4 control-label">珠宝名称:</label>
		                <div class="col-sm-8">
				...
				<div class="col-sm-12">
        			<div class="form-group col-sm-6">
		                <label class="col-sm-4 control-label">珠宝图片:</label>
		                <div class="col-sm-8">
